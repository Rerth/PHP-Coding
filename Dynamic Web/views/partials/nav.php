<?php $server = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH); ?>
...
<nav class="bg-gray-800">
    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <a href="/" class="<?= $server === '/' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Home</a>
            <a href="/about.php" class="<?= $server === '/about.php' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">About</a>
            <a href="/contact.php" class="<?= $server === '/contact.php' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Contact</a>
            <a href="/testing.php" class="<?= $server === '/testing.php' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Testing</a>
            </div>
        </div>
        </div>
        <div class="hidden md:block">
    ...
    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <a href="/" class="block rounded-md <?= $Sever === '/' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">Home</a>
        <a href="/about.php" class="block rounded-md <?= $Sever === '/about.php' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">About</a>
        <a href="/contact.php" class="block rounded-md <?= $Sever === '/contact.php' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">Contact</a>
        <a href="/testing.php" class="block rounded-md <?= $Sever === '/testing.php' ? 'bg-gray-900 text-white ' : 'text-gray-300 ' ?>px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">Testing</a>
    </div>
